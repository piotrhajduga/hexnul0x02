...
export(Material) var water = preload("res://Water.tres.material")
export(Material) var sand = preload("res://Sand.tres.material")
export(Material) var grass = preload("res://Grass.tres.material")
export(Material) var stone = preload("res://Stone.tres.material")
export(Material) var snow = preload("res://Snow.tres.material")
